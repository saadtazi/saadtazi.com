...
const projects: Project = [
  ...
  {
    name: "packrep",
    lead: "Trouver quel npm package (nodejs) vous devriez installer.",
    features: [
  ...
  },
  {
    ...
    lead:
      "Package nodejs permettant la création de profil firefox pouvant être utilisé pour des tests selenium.",
    features: [
  ...
  },
  {
    name: "fakr",
    lead:
      'Un "vrai serveur web de mock" configurable au travers d\'API "restful-ish".',
    features: [
  ...
  },
  {
    ...
    lead:
      'Un "bundle" Symfony qui permet de générer des graphes en utilisant Google Chart Tool, Google Chart Image API et Google Infographics.',
